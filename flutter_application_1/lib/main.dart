...
class MyApp extends StatelessWidget {
  const MyApp({
    super.key,
  }); // <-- Jangan ada kurung kurawal tutup } di baris ini!
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          // <-- Buka SingleChildScrollView
          child: Padding(
            padding: EdgeInsets.all(60.0),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start, // <-- Buka Column
              children: [
                ImageSection(image: 'images/Foto_saya.jpg'),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      TitleSection(
                        ...
                        NIM: '2409106056',
                        location:
                            'Kelas B24, Informatika, Universitas Mulawarman',
                      ),
                      // ButtonSection(),
                      TextSection(
                        description: '''
